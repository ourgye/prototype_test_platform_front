...
export default function Review(props) {
    ...
    const ownerFeedback =
        <div className={props.feedbackDone ? "feedback-done-box": "feedback-done-box feedback-not-done"}>
            피드백 개선 
            {props.feedbackDone ? <>
    ...
    return (
        <div className={props.feedbackDone? "game-review-wrapper feedback-done" : "game-review-wrapper"}>
            <div className="game-header">
                ...
                <div className='feedback-and-count'>
                    {props.owner && (props.feedbackDone ? ownerFeedback : <div className="feedback-done-box">피드백 완료</div>)} 
                    {user.test + "차"}
                </div>
            </div>
